...
class DeeplFreeTranslation {
  ...
  static Future<String> translate(String text, String from, String to) async {
    ...
    final Map<String, dynamic> data = {
      ...
      "params": {
        ...
        "timestamp": _getTimeStamp(_getICount(text)),
      },
      "id": rand,
    };
  ...
  /// 获取翻译文本中 i 的数量
  static int _getICount(String text) {
    return text.split("i").length - 1;
  }

  /// 生成请求随机数
  static int _getRandom() {
    final int random = Random().nextInt(99999) + 100000;
    return random * 1000;
  }

  /// 根据 iCount 生成时间戳
  static int _getTimeStamp(int iCount) {
