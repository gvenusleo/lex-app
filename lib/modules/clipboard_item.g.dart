...
extension ClipboardItemQueryFilter
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QAfterFilterCondition> timeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'time',
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QAfterFilterCondition> timeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ClipboardItemQuerySortBy
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QAfterSortBy> sortByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<ClipboardItem, ClipboardItem, QAfterSortBy> sortByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClipboardItemQuerySortThenBy
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QAfterSortBy> thenByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<ClipboardItem, ClipboardItem, QAfterSortBy> thenByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.desc);
    });
  }
...
extension ClipboardItemQueryWhereDistinct
  ...
  QueryBuilder<ClipboardItem, ClipboardItem, QDistinct> distinctByTime() {
    return QueryBuilder.apply(this, (query) {
...
extension ClipboardItemQueryProperty
  ...
  QueryBuilder<ClipboardItem, DateTime, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
