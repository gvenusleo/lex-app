...
Future<String> translateByVolcengine(
  ...
  final String xDate = getXDate();
  final Map<String, String> headers = {
    "Authorization": getAuthorization(text, from, to, dataHash, xDate),
...
Map<String, String> volcengineSupportLanguage() {
  return {
    "自动": "",
    "中文": "zh",
    "文言文": "lzh",
