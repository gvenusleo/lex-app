...
进入[个人中心](https://niutrans.com/cloud/account_info/info)，查看「API Key」。进入 Lex 设置页面，依次点击「翻译服务」-「小牛翻译」，将「API Key」填入对应位置并保存。

现在就可以在 Lex 中使用小牛翻译服务了。
